...
- Vendored `pi-claude-style-tools@1.0.58` into `pi-better-ux`.
- Added Codex tool display support for `exec_command`, `write_stdin`, and `apply_patch` payloads that use the `input` field.
